...
def export_pdf():
    ...
    if missing_plots:
        print("⚠️ Warning: The following plots were missing and not added to the PDF:")
        for p in missing_plots:
            print(f"   - {p}")
        print("➡️ Tip: Run generate_plots.py or check if PNG export was enabled in Plotly.")
